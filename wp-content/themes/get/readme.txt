...
Get Theme is a blank canvas for your ideas and it makes the block editor your best brush.
...
Take it for a spin! See how Get Theme elevates your portfolio, business website, or personal blog.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Get Theme in the search form and press the 'Enter' key on your keyboard.
...
== Privacy ==
Get Theme uses LocalStorage to save the setting when Dark Mode support is turned on or off.
...
https://wordpress.org/support/article/get-theme-changelog#Version_1.2

= 1.1 =
* Released: December 22, 2020

https://wordpress.org/support/article/get-theme-changelog#Version_1.1

= 1.0 =
* Released: December 8, 2020

https://wordpress.org/support/article/get-theme-changelog#Version_1.0

== Copyright ==

Get Theme WordPress Theme, 2020-2021 WordPress.org
Get Theme is distributed under the terms of the GNU GPL.
...
Get Theme is derived from Seedlet, (C) 2020 Automattic, Inc.

Get Theme is also based on:
